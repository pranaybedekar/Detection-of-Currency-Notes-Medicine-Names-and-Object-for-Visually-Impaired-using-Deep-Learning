...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\PycharmProjects\Medicinedetection\Medicine_Detection'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\PycharmProjects\Medicinedetection\Medicine_Detection\Scripts\deactivate.nu'
